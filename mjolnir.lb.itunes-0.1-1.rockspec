...
local url = "github.com/Linell/mjolnir.lb.itunes"
local desc = "Mjolnir module to control your itunes."

-- LuaDist source
source = {
  tag = "0.1-1",
  url = "git://github.com/LuaDist-testing/mjolnir.lb.itunes.git"
}
-- Original source
-- source = {url = "git://" .. url}
-- description = {
